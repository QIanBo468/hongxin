<template>
  <div class="help">
    <van-nav-bar class="jhnav" @click-left="onClickLeft"  @click-right="onClickRight">
      ...
      <slot slot="title" name="个人资料">帮助</slot>
      <slot slot="right" name="right">帮助记录</slot>
    </van-nav-bar>
    ...
    <div class="help-head acea-row row-center-wrapper">
      <div class="help-contnet-head-left">以提供帮助元(元)</div>
    ...
    <van-button size="large" color="#ffddaa" style="color:#000;">确认</van-button>
  </div>
</template>
