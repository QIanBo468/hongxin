<template>
  <div class="helplock">
    <van-nav-bar class="jhnav" @click-left="onClickLeft">
      ...
      <slot slot="title" name="帮助记录">交易详情</slot>
    </van-nav-bar>
  ...
  methods: {
    ...
    shuaxin() {
      if (this.type == 0) {
        ...
        this.actives = "t";
        this.$axios
          .fetchGet("http://hxly.czxxyk.cn/home/coin/buytrans", {
            id: this.id
          })
          .then(res => {
            console.log(res);
        ...
        console.log("111");
        this.$axios
          .fetchGet("http://hxly.czxxyk.cn/home/coin/selltrans", {
            id: this.id
          })
          .then(res => {
            console.log(res);
    ...
    paysubmit() {
      ...
      if (this.fileList) {
        this.$axios
          .fetchPost("http://hxly.czxxyk.cn/home/coin/coinppdd_pcz", {
    ...
    queren(item) {
      ...
      if (item.zt == 1) {
        this.$axios
          .fetchPost("http://hxly.czxxyk.cn/home/coin/coinppdd_gcz", {
            id: item.id,
            comfir: item.zt
          })
          .then(res => {
